...
exec add_Employee 'aaa',N'Nhâ?t', null, 0123456789,'2022-1-1',false,'manager'


exec add_Account 'abc','0357648144',true
exec add_Account 'aaa','0123456789',false

exec add_Product N'Ca? phê',null,20000,'2000-2-2', N'Không co?'
exec add_Product N'Ga? chiên',null,50000,'2000-2-2',N'Không co?'
exec add_Product N'CocaCola',null,10000,'2000-2-2',N'Không co?'
exec add_Product N'C?m tr?a',null,30000,'2022-9-17','Không co?'
